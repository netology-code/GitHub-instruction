...
Вероятно вы уже добавили в папку с репозиторием файлы вашего рабочего проекта, внесли все необходимые изменения, а также [составили текстовое описание и настроили навигацию внутри репозитория](#markdown). В этом случае настало время для публикации/обновления репозитория на сервере.
